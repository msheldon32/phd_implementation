...
def optimize_start(rebalancing_cost, bounce_cost, run_price=True, run_xdiff=True):
    ...
    temperature = temperature * (annealing_alpha**(30))
    ...
    starting_level = 10.0
    prices = [[1.0 for cell_idx in range(n_cells)] for hr in start_hours]
    #prices = [[0.9, 1.0, 1.3000000000000003, 1.3000000000000003, 1.3000000000000003, 1.0, 0.9, 0.9, 1.0, 0.9, 1.4000000000000004, 1.2000000000000002, 0.9, 1.0, 0.9, 1.3000000000000003, 1.0, 1.0, 1.1, 0.9, 1.3000000000000003, 1.1, 0.6000000000000001, 1.3000000000000003, 0.7000000000000001, 1.1, 1.1, 1.1, 1.2000000000000002, 1.0, 1.1, 1.4000000000000004, 0.8999999999999999, 1.2000000000000002, 1.3000000000000003, 0.9, 1.1, 1.0, 1.1, 1.0, 0.8, 1.2000000000000002, 1.1, 1.0, 0.9, 0.9, 1.3000000000000003, 1.0, 0.6000000000000001, 1.2000000000000002, 1.1, 0.9, 1.0, 1.2000000000000002, 1.1, 1.0, 1.2000000000000002, 0.6000000000000001] for hr in start_hours]
    ...
    #cell_levels = [9.0, 14.0, 5.0, 9.0, 13.0, 18.0, 2.0, 12.0, 16.0, 25.0, 12.0, 9.0, 24.0, 8.0, 15.0, 10.0, 15.0, 18.0, 12.0, 15.0, 14.0, 14.0, 10.0, 10.0, 8.0, 16.0, 16.0, 15.0, 14.0, 16.0, 17.0, 14.0, 7.0, 18.0, 22.0, 11.0, 20.0, 21.0, 9.0, 16.0, 22.0, 13.0, 9.0, 10.0, 17, 14.0, 10.0, 11.0, 10.0, 10.0, 5.0, 4.0, 10.0, 10.0, 14.0, 16.0, 10.0, 12.0]
