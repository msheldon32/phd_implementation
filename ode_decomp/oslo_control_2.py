...
def optimize_price_start(rebalancing_cost, bounce_cost, change_x=True):
    starting_level = 10.0
...
if __name__ == "__main__":
    ...
    #price_search()
    raise Exception("fix rebalancing cost deriv")
    optimize_price_start(0.0, 1.0, change_x=False)
