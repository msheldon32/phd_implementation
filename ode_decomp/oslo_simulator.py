...
if __name__ == "__main__":
    ...
    #prices = [0.9000000000000002, 1.2000000000000002, 0.9999999999999999, 0.8, 0.9000000000000006, 0.8999999999999999, 0.9000000000000005, 1.3000000000000005, 0.8000000000000005, 1.3, 1.3000000000000005, 0.7999999999999999, 1.0000000000000002, 1.1000000000000003, 1.0999999999999999, 1.2000000000000002, 1.3000000000000005, 1.2, 1.1, 1.2000000000000004, 1.0, 0.9, 1.1, 1.2000000000000008, 1.2000000000000008, 1.1000000000000003, 1.4999999999999996, 1.2, 1.2000000000000004, 1.0, 1.2000000000000002, 0.9999999999999999, 1.0000000000000002, 0.9000000000000002, 1.0, 1.2000000000000002, 0.8000000000000003, 1.1, 1.2000000000000002, 1.3000000000000003, 0.7000000000000001, 0.9000000000000002, 1.0]
    print(f"average price: {sum(prices)/len(prices)}")
    

    starting_levels = [0.5 for i in range(n_cells)]
    starting_levels = [0.20000000000000004, 0.7, 0.7999999999999999, 0.30000000000000004, 0.10000000000000003, 0.4, 0.30000000000000004, 0.7999999999999999, 0.10000000000000003, 0.7999999999999999, 0.6, 0.20000000000000004, 0.7, 0.7999999999999999, 0.6, 0.7999999999999999, 0.8999999999999999, 0.7999999999999999, 0.7999999999999999, 0.7999999999999999, 0.7, 0.6, 0.7, 0.7, 0.7, 0.7, 0.5, 0.8999999999999999, 0.7, 0.7, 0.7, 0.6, 0.4, 0.30000000000000004, 0.5, 0.7999999999999999, 0.4, 0.8999999999999999, 0.8999999999999999, 0.8999999999999999, 0.10000000000000003, 0.4, 0.6]
